...
def main() -> int:
    ...
    assert_contains(SRC / "panel.lua", "local function page_button_width(wide)")
    assert_contains(SRC / "panel.lua", "local function toolbar_body_width(wide)")
    ...
    assert_contains(SRC / "panel.lua", "drag.style.size = { math.max(40, toolbar_body_width(wide) - 152), 20 }")
