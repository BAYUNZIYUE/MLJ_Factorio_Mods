...
def main() -> int:
    ...
    assert_contains(SRC / "panel.lua", "head.drag_target = frame")
    assert_contains(SRC / "panel.lua", "drag.style.width = 160")
    assert_contains(SRC / "panel.lua", "tab.style.width = 28")
    assert_contains(SRC / "data.lua", 'width = 28')
